...
import './mesage_send_to_email.css';
  ...
  return (
    <div className="background-container" style={{ backgroundImage: `url(${background})` }}>
      <div className="content">
        ...
        <div className="right_sign mesage">
          ...
          <div className="form_input">
            ...
            {/* Error message box - will show when Errorvisible is true */}
                ...
                <div className='mesage_corect'>
                <GiConfirmed className='icon_corect'/>
                <span>An e-mail has been sent to your address with instructions to recover your password</span>
                </div>
